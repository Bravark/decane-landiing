...
const Banner = () => {
    return (
        <div className='flex flex-col items-center justify-center'>
            <h1 className='font-russo-one text-black text-8xl max-w-[30rem] text-center'>
                Own <span className='text-[#D5B300] font-rouge-script text-[116.1px]'>your
                </span> Flow</h1>

            <div className='relative'>
                <Image src={Decane} alt="penguin" className='-mt-[15rem]' />
                <Image src={RightHand} alt="left-hand" className='absolute -bottom-4 left-[36%]' />
                <Image src={LeftHand} alt="right-hand" className='absolute -bottom-4 right-[36%]' />
            </div>
            ...
            <div className="flex-1 flex items-center justify-end mt-28">
                <Link
                    href={'#'}
                    className="inline-flex justify-center items-center gap-[0.63rem] py-4 w-[624px] bg-decane-yellow rounded-[2.8125rem] font-figtree"
                >
