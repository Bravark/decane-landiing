...
const Footer = () => {
    return (
        <div className='bg-[linear-gradient(90deg,#0D0D0D_0%,#0D0D0D_55%,#0D0D0D_100%)] z-40 rounded-[40px] h-[500px] xl:mx-72 mx-12 relative overflow-auto mt-20 mb-14'>
            ...
            <div className='flex items-start justify-between mt-16 mx-7 xl:mx-14'>
                ...
                <div className='backdrop-blur-[16px] w-[500px] xl:w-[600px] xl:px-7 py-[18px] rounded border border-[#FEFEFE]  flex items-center justify-between'>
                    ...
                    <div className='flex items-center justify-center gap-2 bg-black xl:py-3 xl:px-8 py-2 px-4 rounded-xl cursor-pointer lg:mr-4 xl:mr-0'>
